...
if(Datafromserver) {
	pdfFileName="~/Desktop/HobbsCoast.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HobbsCoast.pdf"}

siteName="Hobbs Coast     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HobbsCoast.csv",
	url<-"~/Sites/AntT/Data/rdata/HobbsCoast.csv"
	)
