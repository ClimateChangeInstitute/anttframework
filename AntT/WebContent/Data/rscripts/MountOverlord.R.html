...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountOverlord.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountOverlord.pdf"}

siteName="Mount Overlord  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountOverlord.csv",
	url<-"~/Sites/AntT/Data/rdata/MountOverlord.csv"
	)
