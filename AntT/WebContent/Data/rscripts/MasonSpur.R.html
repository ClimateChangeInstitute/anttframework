...
if(Datafromserver) {
	pdfFileName="~/Desktop/MasonSpur.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MasonSpur.pdf"}
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MasonSpur.csv",
	url<-"~/Sites/AntT/Data/rdata/MasonSpur.csv"
	)
