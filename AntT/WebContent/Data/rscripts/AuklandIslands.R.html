...
if(Datafromserver) {
	pdfFileName="~/Desktop/AuklandIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/AuklandIslands.pdf"}

siteName="Aukland Islands                        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/AuklandIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/AuklandIslands.csv"
	)
#Number of lines with data 13-4 =9
Nlines = 9
