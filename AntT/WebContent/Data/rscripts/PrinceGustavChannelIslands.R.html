###########################################
#File PrinceGustavChannelIslands.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/PrinceGustavChannelIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/PrinceGustavChannelIslands.pdf"}

siteName="Prince Gustav Channel Islands"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/PrinceGustavChannelIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/PrinceGustavChannelIslands.csv"
	)
#Number of lines with data 6-4 =2
Nlines = 2
