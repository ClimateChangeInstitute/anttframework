###########################################
#File MountPetrasAndUsasEscarpment.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountPetrasAndUsasEscarpment.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountPetrasAndUsasEscarpment.pdf"}

siteName="Mount Petras And Usas Escarpment"
regionName="Marie Byrd Land"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountPetrasAndUsasEscarpment.csv",
	url<-"~/Sites/AntT/Data/rdata/MountPetrasAndUsasEscarpment.csv"
	)
#Number of lines with data 8-4 =4
Nlines = 4
