...
if(Datafromserver) {
	pdfFileName="~/Desktop/FosdickMountains.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/FosdickMountains.pdf"}

siteName="Fosdick Mountains"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/FosdickMountains.csv",
	url<-"~/Sites/AntT/Data/rdata/FosdickMountains.csv"
	)
