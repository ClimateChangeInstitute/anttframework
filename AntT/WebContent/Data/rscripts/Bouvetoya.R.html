...
if(Datafromserver) {
	pdfFileName="~/Desktop/Bouvetoya.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/Bouvetoya.pdf"}
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/Bouvetoya.csv",
	url<-"~/Sites/AntT/Data/rdata/Bouvetoya.csv"
	)
