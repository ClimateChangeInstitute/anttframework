...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountHampton.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountHampton.pdf"}

siteName="Mount Hampton      "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountHampton.csv",
	url<-"~/Sites/AntT/Data/rdata/MountHampton.csv"
	)
#Number of lines with data 18-4 =14
Nlines = 14
