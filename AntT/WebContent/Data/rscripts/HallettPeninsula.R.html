...
if(Datafromserver) {
	pdfFileName="~/Desktop/HallettPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HallettPeninsula.pdf"}

siteName="Hallett Peninsula  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HallettPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/HallettPeninsula.csv"
	)
