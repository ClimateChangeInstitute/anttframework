...
if(Datafromserver) {
	pdfFileName="~/Desktop/RydbergPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/RydbergPeninsula.pdf"}

siteName="Rydberg Peninsula                              "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/RydbergPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/RydbergPeninsula.csv"
	)
#Number of lines with data 5-4 =1
Nlines = 1
