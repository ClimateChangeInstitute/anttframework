...
if(Datafromserver) {
	pdfFileName="~/Desktop/CookIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/CookIsland.pdf"}

siteName="Cook Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/CookIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/CookIsland.csv"
	)
