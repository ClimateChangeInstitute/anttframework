...
if(Datafromserver) {
	pdfFileName="~/Desktop/ThePleiades.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ThePleiades.pdf"}

siteName="The Pleiades  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ThePleiades.csv",
	url<-"~/Sites/AntT/Data/rdata/ThePleiades.csv"
	)
