...
if(Datafromserver) {
	pdfFileName="~/Desktop/VulcanHills.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/VulcanHills.pdf"}

siteName="Vulcan Hills        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/VulcanHills.csv",
	url<-"~/Sites/AntT/Data/rdata/VulcanHills.csv"
	)
