...
if(Datafromserver) {
	pdfFileName="~/Desktop/RoyalSocietyRange.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/RoyalSocietyRange.pdf"}

siteName="RoyalSocietyRange     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/RoyalSocietyRange.csv",
	url<-"~/Sites/AntT/Data/rdata/RoyalSocietyRange.csv"
	)
