...
if(Datafromserver) {
	pdfFileName="~/Desktop/PauletIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/PauletIsland.pdf"}

siteName="Paulet Island                            "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/PauletIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/PauletIsland.csv"
	)
