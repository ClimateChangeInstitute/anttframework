...
if(Datafromserver) {
	pdfFileName="~/Desktop/VisokoiIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/VisokoiIsland.pdf"}

siteName="Visokoi Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/VisokoiIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/VisokoiIsland.csv"
	)
