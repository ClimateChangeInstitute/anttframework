...
if(Datafromserver) {
	pdfFileName="~/Desktop/ToneyMountain.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ToneyMountain.pdf"}

siteName="Toney Mountain   "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ToneyMountain.csv",
	url<-"~/Sites/AntT/Data/rdata/ToneyMountain.csv"
	)
#Number of lines with data 27-4 =23
Nlines = 23
