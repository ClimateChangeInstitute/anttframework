...
if(Datafromserver) {
	pdfFileName="~/Desktop/IlesKerguelen.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/IlesKerguelen.pdf"}

siteName="Iles Kerguelen                     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/IlesKerguelen.csv",
	url<-"~/Sites/AntT/Data/rdata/IlesKerguelen.csv"
	)
#Number of lines with data 14-4 =10
Nlines = 10
