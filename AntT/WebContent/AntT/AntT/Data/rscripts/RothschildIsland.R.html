...
if(Datafromserver) {
	pdfFileName="~/Desktop/RothschildIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/RothschildIsland.pdf"}

siteName="Rothschild Island                                 "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/RothschildIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/RothschildIsland.csv"
	)
