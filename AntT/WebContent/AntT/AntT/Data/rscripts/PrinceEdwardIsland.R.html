...
if(Datafromserver) {
	pdfFileName="~/Desktop/PrinceEdwardIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/PrinceEdwardIsland.pdf"}

siteName=" Prince Edward Island         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/PrinceEdwardIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/PrinceEdwardIsland.csv"
	)
