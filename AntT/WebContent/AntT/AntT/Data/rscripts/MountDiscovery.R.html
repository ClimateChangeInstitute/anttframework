...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountDiscovery.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountDiscovery.pdf"}

siteName="Mount Dicovery          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountDiscovery.csv",
	url<-"~/Sites/AntT/Data/rdata/MountDiscovery.csv"
	)
