...
if(Datafromserver) {
	pdfFileName="~/Desktop/BellingshausenIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/BellingshausenIsland.pdf"}

siteName="Bellingshausen Island "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BellingshausenIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/BellingshausenIsland.csv"
	)
