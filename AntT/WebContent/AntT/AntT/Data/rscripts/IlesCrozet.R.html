...
if(Datafromserver) {
	pdfFileName="~/Desktop/IlesCrozet.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/IlesCrozet.pdf"}

siteName="Iles Crozet                          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/IlesCrozet.csv",
	url<-"~/Sites/AntT/Data/rdata/IlesCrozet.csv"
	)
