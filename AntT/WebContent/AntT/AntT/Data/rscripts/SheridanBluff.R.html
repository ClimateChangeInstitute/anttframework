...
if(Datafromserver) {
	pdfFileName="~/Desktop/SheridanBluff.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/SheridanBluff.pdf"}

siteName="Sheridan Bluff          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/SheridanBluff.csv",
	url<-"~/Sites/AntT/Data/rdata/SheridanBluff.csv"
	)
