...
if(Datafromserver) {
	pdfFileName="~/Desktop/MerrickMountains.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MerrickMountains.pdf"}

siteName="Merrick Mountains                               "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MerrickMountains.csv",
	url<-"~/Sites/AntT/Data/rdata/MerrickMountains.csv"
	)
