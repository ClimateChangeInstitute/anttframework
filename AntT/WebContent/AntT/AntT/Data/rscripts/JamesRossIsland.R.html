...
if(Datafromserver) {
	pdfFileName="~/Desktop/JamesRossIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/JamesRossIsland.pdf"}

siteName="James Ross Island                   "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/JamesRossIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/JamesRossIsland.csv"
	)
