...
if(Datafromserver) {
	pdfFileName="~/Desktop/FranklinIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/FranklinIsland.pdf"}

siteName="Franklin Island   "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/FranklinIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/FranklinIsland.csv"
	)
