...
if(Datafromserver) {
	pdfFileName="~/Desktop/HutPointPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HutPointPeninsula.pdf"}

siteName="Hut Point Peninsula  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HutPointPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/HutPointPeninsula.csv"
	)
