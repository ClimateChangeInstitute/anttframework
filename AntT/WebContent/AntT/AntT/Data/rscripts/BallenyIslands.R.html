...
if(Datafromserver) {
	pdfFileName="~/Desktop/BallenyIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/BallenyIslands.pdf"}

siteName="Balleny Islands                    "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BallenyIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/BallenyIslands.csv"
	)
