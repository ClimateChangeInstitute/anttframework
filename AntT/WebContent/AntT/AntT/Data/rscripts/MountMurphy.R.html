...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountMurphy.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountMurphy.pdf"}

siteName="Mount Murphy   "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountMurphy.csv",
	url<-"~/Sites/AntT/Data/rdata/MountMurphy.csv"
	)
#Number of lines with data 22-4 =18
Nlines = 18
