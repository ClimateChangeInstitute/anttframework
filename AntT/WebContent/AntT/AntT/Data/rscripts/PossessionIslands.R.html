...
if(Datafromserver) {
	pdfFileName="~/Desktop/PossessionIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/PossessionIslands.pdf"}

siteName="Possession Islands  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/PossessionIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/PossessionIslands.csv"
	)
