...
if(Datafromserver) {
	pdfFileName="~/Desktop/MaltaPlateau.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MaltaPlateau.pdf"}

siteName="Malta Plateau  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MaltaPlateau.csv",
	url<-"~/Sites/AntT/Data/rdata/MaltaPlateau.csv"
	)
