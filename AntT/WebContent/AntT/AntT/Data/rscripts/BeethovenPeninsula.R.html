...
if(Datafromserver) {
	pdfFileName="~/Desktop/BeethovenPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/BeethovenPeninsula.pdf"}

siteName="Beethoven Peninsula                           "
regionName="Alexander Island, Palmer Land, and Ellsworth Land"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BeethovenPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/BeethovenPeninsula.csv"
	)
