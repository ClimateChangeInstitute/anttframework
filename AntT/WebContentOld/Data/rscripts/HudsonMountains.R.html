...
if(Datafromserver) {
	pdfFileName="~/Desktop/HudsonMountains.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HudsonMountains.pdf"}

siteName="Hudson Mountains                                "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HudsonMountains.csv",
	url<-"~/Sites/AntT/Data/rdata/HudsonMountains.csv"
	)
#Number of lines with data 11-4 =7
Nlines = 7
