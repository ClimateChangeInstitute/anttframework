###########################################
#File LocalSuiteBasalticRocks.R
##Version 2
# #  Andrei Kurbatov
# #  Tyler Sullivan
## April 2016
...
if(Datafromserver) {
	pdfFileName="~/Desktop/LocalSuiteBasalticRocks.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/LocalSuiteBasalticRocks.pdf"}

siteName="Local Suite Basaltic Rocks "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/LocalSuiteBasalticRocks.csv",
	url<-"~/Sites/AntT/Data/rdata/LocalSuiteBasalticRocks.csv"
	)
