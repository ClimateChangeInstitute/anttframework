...
if(Datafromserver) {
	pdfFileName="~/Desktop/KrakowPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/KrakowPeninsula.pdf"}

siteName="Krakow Peninsula                    "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/KrakowPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/KrakowPeninsula.csv"
	)
