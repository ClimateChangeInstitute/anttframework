...
if(Datafromserver) {
	pdfFileName="~/Desktop/SealNunataks.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/SealNunataks.pdf"}

siteName="Seal Nunataks                         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/SealNunataks.csv",
	url<-"~/Sites/AntT/Data/rdata/SealNunataks.csv"
	)
