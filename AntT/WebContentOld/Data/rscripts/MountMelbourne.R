...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountMelbourne.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountMelbourne.pdf"}

siteName="Mount Melbourne  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountMelbourne.csv",
	url<-"~/Sites/AntT/Data/rdata/MountMelbourne.csv"
	)
