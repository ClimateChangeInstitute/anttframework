...
if(Datafromserver) {
	pdfFileName="~/Desktop/MontaguIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MontaguIsland.pdf"}

siteName="Montagu Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MontaguIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/MontaguIsland.csv"
	)
