...
if(Datafromserver) {
	pdfFileName="~/Desktop/HenryNunataks.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HenryNunataks.pdf"}

siteName="Henry Nunataks                                  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HenryNunataks.csv",
	url<-"~/Sites/AntT/Data/rdata/HenryNunataks.csv"
	)
