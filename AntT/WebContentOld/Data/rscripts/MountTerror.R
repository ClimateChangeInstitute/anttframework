...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountTerror.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountTerror.pdf"}

siteName="Mount Terror      "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountTerror.csv",
	url<-"~/Sites/AntT/Data/rdata/MountTerror.csv"
	)
