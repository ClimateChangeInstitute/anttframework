###########################################
#File HeardandMcDonaldIslands.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/HeardandMcDonaldIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HeardandMcDonaldIslands.pdf"}

siteName="Heard and McDonald Islands"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HeardandMcDonaldIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/HeardandMcDonaldIslands.csv"
	)
