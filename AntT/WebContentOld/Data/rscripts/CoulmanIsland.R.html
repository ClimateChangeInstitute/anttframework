...
if(Datafromserver) {
	pdfFileName="~/Desktop/CoulmanIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/CoulmanIsland.pdf"}

siteName="Coulman Island  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/CoulmanIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/CoulmanIsland.csv"
	)
