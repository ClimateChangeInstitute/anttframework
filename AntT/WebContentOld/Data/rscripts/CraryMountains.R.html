...
if(Datafromserver) {
	pdfFileName="~/Desktop/CraryMountains.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/CraryMountains.pdf"}

siteName="Crary Mountains  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/CraryMountains.csv",
	url<-"~/Sites/AntT/Data/rdata/CraryMountains.csv"
	)
