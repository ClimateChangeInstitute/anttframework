...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountBerlin.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountBerlin.pdf"}

siteName="Mount Berlin   "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountBerlin.csv",
	url<-"~/Sites/AntT/Data/rdata/MountBerlin.csv"
	)
#Number of lines with data 19-4 =15
Nlines = 15
