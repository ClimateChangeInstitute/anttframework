...
if(Datafromserver) {
	pdfFileName="~/Desktop/MacQuarieIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MacQuarieIsland.pdf"}

siteName="MacQuarie Island                      "
regionName="Subantarctic Volcanoes of the Pacific Plate"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MacQuarieIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/MacQuarieIsland.csv"
	)
