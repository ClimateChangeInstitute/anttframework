...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountBird.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountBird.pdf"}
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountBird.csv",
	url<-"~/Sites/AntT/Data/rdata/MountBird.csv"
	)
