...
if(Datafromserver) {
	pdfFileName="~/Desktop/PenguinIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/PenguinIsland.pdf"}

siteName="Penguin Island                         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/PenguinIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/PenguinIsland.csv"
	)
