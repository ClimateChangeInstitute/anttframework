###########################################
#File TabarinPeninsulaandDundeeIsland.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/TabarinPeninsulaandDundeeIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/TabarinPeninsulaandDundeeIsland.pdf"}

siteName="Tabarin Peninsula and Dundee Island"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BrabantIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/BrabantIsland.csv"
	)
