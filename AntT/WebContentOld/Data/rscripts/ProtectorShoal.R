...
if(Datafromserver) {
	pdfFileName="~/Desktop/ProtectorShoal.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ProtectorShoal.pdf"}

siteName="Protector Shoal        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ProtectorShoal.csv",
	url<-"~/Sites/AntT/Data/rdata/ProtectorShoal.csv"
	)
