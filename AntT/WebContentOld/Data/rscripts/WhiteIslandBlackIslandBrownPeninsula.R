###########################################
#File WhiteIslandBlackIslandBrownPeninsula.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/WhiteIslandBlackIslandBrownPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/WhiteIslandBlackIslandBrownPeninsula.pdf"}

siteName="White Island Black Island Brown Peninsula "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/WhiteIslandBlackIslandBrownPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/WhiteIslandBlackIslandBrownPeninsula.csv"
	)
#Number of lines with data 10-4 =6
Nlines = 6
