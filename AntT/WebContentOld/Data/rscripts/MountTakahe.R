...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountTakahe.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountTakahe.pdf"}

siteName="Mount Takahe          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountTakahe.csv",
	url<-"~/Sites/AntT/Data/rdata/MountTakahe.csv"
	)
