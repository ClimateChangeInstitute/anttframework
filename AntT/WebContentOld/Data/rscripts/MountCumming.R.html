...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountCumming.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountCumming.pdf"}

siteName="Mount Cumming     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountCumming.csv",
	url<-"~/Sites/AntT/Data/rdata/MountCumming.csv"
	)
