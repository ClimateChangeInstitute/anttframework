...
if(Datafromserver) {
	pdfFileName="~/Desktop/BristolIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/BristolIsland.pdf"}

siteName="Bristol Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BristolIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/BristolIsland.csv"
	)
