...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountMoulton.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountMoulton.pdf"}

siteName="Mount Moulton     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountMoulton.csv",
	url<-"~/Sites/AntT/Data/rdata/MountMoulton.csv"
	)
