...
if(Datafromserver) {
	pdfFileName="~/Desktop/DaniellPeninsula.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/DaniellPeninsula.pdf"}
siteName="Daniell Peninsula "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/DaniellPeninsula.csv",
	url<-"~/Sites/AntT/Data/rdata/DaniellPeninsula.csv"
	)
