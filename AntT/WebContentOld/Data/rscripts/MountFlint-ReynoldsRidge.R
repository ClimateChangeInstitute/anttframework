###########################################
#File MountFlint-ReynoldsRidge.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountFlint-ReynoldsRidge.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountFlint-ReynoldsRidge.pdf"}

siteName="Mount Flint- Reynolds Ridge"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountFlint-ReynoldsRidge.csv",
	url<-"~/Sites/AntT/Data/rdata/MountFlint-ReynoldsRidge.csv"
	)
#Number of lines with data 15-4 =11
Nlines = 11
