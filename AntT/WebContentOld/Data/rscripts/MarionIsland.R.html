...
if(Datafromserver) {
	pdfFileName="~/Desktop/MarionIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MarionIsland.pdf"}

siteName="Marion Island                           "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MarionIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/MarionIsland.csv"
	)
#Number of lines with data 17-4 =13
Nlines = 13
