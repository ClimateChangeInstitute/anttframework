...
if(Datafromserver) {
	pdfFileName="~/Desktop/ThuleIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ThuleIsland.pdf"}

siteName="Thule Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ThuleIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/ThuleIsland.csv"
	)
