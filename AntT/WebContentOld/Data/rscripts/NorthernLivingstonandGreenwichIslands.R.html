###########################################
#File NorthernLivingstonandGreenwichIslands.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/NorthernLivingstonandGreenwichIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/NorthernLivingstonandGreenwichIslands.pdf"}

siteName="Northern Livingston and Greenwich Islands"
regionName="Graham Land and South Shetland Islands"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/NorthernLivingstonandGreenwichIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/NorthernLivingstonandGreenwichIslands.csv"
	)
