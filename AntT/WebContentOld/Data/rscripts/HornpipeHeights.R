...
if(Datafromserver) {
	pdfFileName="~/Desktop/HornpipeHeights.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HornpipeHeights.pdf"}

siteName="Hornpipe Heights                                 "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HornpipeHeights.csv",
	url<-"~/Sites/AntT/Data/rdata/HornpipeHeights.csv"
	)
