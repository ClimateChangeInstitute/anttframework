...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountEarly.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountEarly.pdf"}

siteName="Mount Early          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountEarly.csv",
	url<-"~/Sites/AntT/Data/rdata/MountEarly.csv"
	)
