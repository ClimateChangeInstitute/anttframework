...
#1
if(Datafromserver) {
	pdfFileName="~/Desktop/BeaufortIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/BeaufortIsland.pdf"}
#2
siteName="BeaufortIsland    "
...
#3
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BeaufortIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/BeaufortIsland.csv"
	)
