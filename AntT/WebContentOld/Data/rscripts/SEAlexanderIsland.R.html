...
if(Datafromserver) {
	pdfFileName="~/Desktop/SEAlexanderIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/SEAlexanderIsland.pdf"}

siteName="SEAlexander Island                             "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/SEAlexanderIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/SEAlexanderIsland.csv"
	)
