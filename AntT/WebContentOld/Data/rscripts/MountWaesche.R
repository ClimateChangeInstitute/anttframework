...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountWaesche.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountWaesche.pdf"}

siteName="Mount Waesche  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountWaesche.csv",
	url<-"~/Sites/AntT/Data/rdata/MountWaesche.csv"
	)
#Number of lines with data 25-4 =21
Nlines = 21
