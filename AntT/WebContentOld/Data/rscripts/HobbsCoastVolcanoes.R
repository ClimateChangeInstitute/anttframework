...
if(Datafromserver) {
	pdfFileName="~/Desktop/HobbsCoastVolcanoes.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/HobbsCoastVolcanoes.pdf"}

siteName="Hobbs Coast Volcanoes"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/HobbsCoastVolcanoes.csv",
	url<-"~/Sites/AntT/Data/rdata/HobbsCoastVolcanoes.csv"
	)
#Number of lines with data 9-4 =5
Nlines = 5
