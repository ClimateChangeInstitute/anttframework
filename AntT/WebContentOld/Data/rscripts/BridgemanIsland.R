...
if(Datafromserver) {
	pdfFileName="~/Desktop/BridgemanIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/BridgemanIsland.pdf"}

siteName="Bridgeman Island                     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/BridgemanIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/BridgemanIsland.csv"
	)
