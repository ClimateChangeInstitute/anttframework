...
if(Datafromserver) {
	pdfFileName="~/Desktop/CampbellIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/CampbellIsland.pdf"}

siteName="Campbell Island                         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/CampbellIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/CampbellIsland.csv"
	)
