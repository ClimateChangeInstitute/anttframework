...
if(Datafromserver) {
	pdfFileName="~/Desktop/JonesMountains.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/JonesMountains.pdf"}

siteName="Jones Mountains                                 "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/JonesMountains.csv",
	url<-"~/Sites/AntT/Data/rdata/JonesMountains.csv"
	)
