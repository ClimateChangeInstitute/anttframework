...
if(Datafromserver) {
	pdfFileName="~/Desktop/Gaussberg.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/Gaussberg.pdf"}
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/Gaussberg.csv",
	url<-"~/Sites/AntT/Data/rdata/Gaussberg.csv"
	)
