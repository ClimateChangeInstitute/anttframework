...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountHartigan.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountHartigan.pdf"}

siteName="Mount Hartigan     "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountHartigan.csv",
	url<-"~/Sites/AntT/Data/rdata/MountHartigan.csv"
	)
