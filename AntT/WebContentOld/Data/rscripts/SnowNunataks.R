...
if(Datafromserver) {
	pdfFileName="~/Desktop/SnowNunataks.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/SnowNunataks.pdf"}

siteName="Snow Nunataks                                    "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/SnowNunataks.csv",
	url<-"~/Sites/AntT/Data/rdata/SnowNunataks.csv"
	)
