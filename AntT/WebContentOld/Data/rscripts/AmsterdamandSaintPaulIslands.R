###########################################
#File AmsterdamandSaintPaulIslands.R
##Version 1
# #  Andrei Kurbatov
# #  Tyler Sullivan
## July 2013
...
if(Datafromserver) {
	pdfFileName="~/Desktop/AmsterdamandSaintPaulIslands.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/AmsterdamandSaintPaulIslands.pdf"}

siteName="Amsterdam and Saint Paul Islands"
regionName="Oceanic Islands on the Antarctic Plate"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/AmsterdamandSaintPaulIslands.csv",
	url<-"~/Sites/AntT/Data/rdata/AmsterdamandSaintPaulIslands.csv"
	)
#Number of lines with data 12-4 =8
Nlines = 8
