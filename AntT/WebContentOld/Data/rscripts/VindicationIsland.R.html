...
if(Datafromserver) {
	pdfFileName="~/Desktop/VindicationIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/VindicationIsland.pdf"}

siteName="Vindication Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/VindicationIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/VindicationIsland.csv"
	)
