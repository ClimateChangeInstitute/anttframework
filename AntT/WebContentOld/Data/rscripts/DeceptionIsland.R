...
if(Datafromserver) {
	pdfFileName="~/Desktop/DeceptionIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/DeceptionIsland.pdf"}

siteName="Deception Island                      "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/DeceptionIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/DeceptionIsland.csv"
	)
