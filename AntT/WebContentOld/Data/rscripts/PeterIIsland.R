...
if(Datafromserver) {
	pdfFileName="~/Desktop/PeterIIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/PeterIIsland.pdf"}

siteName="Peter I Island                         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/PeterIIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/PeterIIsland.csv"
	)
