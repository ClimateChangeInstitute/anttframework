...
if(Datafromserver) {
	pdfFileName="~/Desktop/TaylorValley.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/TaylorValley.pdf"}

siteName="Taylor Valley          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/TaylorValley.csv",
	url<-"~/Sites/AntT/Data/rdata/TaylorValley.csv"
	)
