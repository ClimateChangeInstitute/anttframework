...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountSidley.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountSidley.pdf"}

siteName="Mount Sidley      "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountSidley.csv",
	url<-"~/Sites/AntT/Data/rdata/MountSidley.csv"
	)
