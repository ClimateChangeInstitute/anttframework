...
if(Datafromserver) {
	pdfFileName="~/Desktop/ZavodovskiIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ZavodovskiIsland.pdf"}

siteName="Zavodovski Island"
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ZavodovskiIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/ZavodovskiIsland.csv"
	)
