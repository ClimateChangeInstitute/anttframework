...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountBursey.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountBursey.pdf"}

siteName="Mount Bursey      "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountBursey.csv",
	url<-"~/Sites/AntT/Data/rdata/MountBursey.csv"
	)
