...
if(Datafromserver) {
	pdfFileName="~/Desktop/CandlemasIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/CandlemasIsland.pdf"}

siteName="Candlemas Island        "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/CandlemasIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/CandlemasIsland.csv"
	)
