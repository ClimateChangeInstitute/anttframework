...
if(Datafromserver) {
	pdfFileName="~/Desktop/WalgreenCoast.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/WalgreenCoast.pdf"}

siteName="Walgreen Coast  "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/WalgreenCoast.csv",
	url<-"~/Sites/AntT/Data/rdata/WalgreenCoast.csv"
	)
