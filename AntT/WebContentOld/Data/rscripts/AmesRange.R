...
if(Datafromserver) {
	pdfFileName="~/Desktop/AmesRange.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/AmesRange.pdf"}
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/AmesRange.csv",
	url<-"~/Sites/AntT/Data/rdata/AmesRange.csv"
	)
