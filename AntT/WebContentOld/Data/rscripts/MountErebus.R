...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountErebus.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountErebus.pdf"}

siteName="Mount Erebus         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountErebus.csv",
	url<-"~/Sites/AntT/Data/rdata/MountErebus.csv"
	)
