...
if(Datafromserver) {
	pdfFileName="~/Desktop/ArgoPoint.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ArgoPoint.pdf"}
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ArgoPoint.csv",
	url<-"~/Sites/AntT/Data/rdata/ArgoPoint.csv"
	)
