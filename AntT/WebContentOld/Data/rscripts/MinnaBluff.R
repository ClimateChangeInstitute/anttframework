...
if(Datafromserver) {
	pdfFileName="~/Desktop/MinnaBluff.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MinnaBluff.pdf"}

siteName="Minna Bluff          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MinnaBluff.csv",
	url<-"~/Sites/AntT/Data/rdata/MinnaBluff.csv"
	)
