...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountSiple.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountSiple.pdf"}

siteName="Mount Siple       "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountSiple.csv",
	url<-"~/Sites/AntT/Data/rdata/MountSiple.csv"
	)
