...
if(Datafromserver) {
	pdfFileName="~/Desktop/ScottIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/ScottIsland.pdf"}

siteName="Scott Island                         "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/ScottIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/ScottIsland.csv"
	)
