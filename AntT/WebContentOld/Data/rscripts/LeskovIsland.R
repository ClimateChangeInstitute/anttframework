...
if(Datafromserver) {
	pdfFileName="~/Desktop/LeskovIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/LeskovIsland.pdf"}

siteName="Leskov Island    "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/LeskovIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/LeskovIsland.csv"
	)
