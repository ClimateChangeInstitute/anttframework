...
if(Datafromserver) {
	pdfFileName="~/Desktop/MelvillePeak.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MelvillePeak.pdf"}

siteName="Melville Peak                           "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MelvillePeak.csv",
	url<-"~/Sites/AntT/Data/rdata/MelvillePeak.csv"
	)
