...
if(Datafromserver) {
	pdfFileName="~/Desktop/AntipodesIsland.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/AntipodesIsland.pdf"}

siteName="Antipodes Island                       "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/AntipodesIsland.csv",
	url<-"~/Sites/AntT/Data/rdata/AntipodesIsland.csv"
	)
