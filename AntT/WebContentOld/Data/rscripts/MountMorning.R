...
if(Datafromserver) {
	pdfFileName="~/Desktop/MountMorning.pdf"
	} else {pdfFileName="~/Sites/AntT/Data/rplots/MountMorning.pdf"}

siteName="Mount Morning          "
...
ifelse(Datafromserver,
	url<-"http://www.tephrochronology.org/AntT/Data/rdata/MountMorning.csv",
	url<-"~/Sites/AntT/Data/rdata/MountMorning.csv"
	)
